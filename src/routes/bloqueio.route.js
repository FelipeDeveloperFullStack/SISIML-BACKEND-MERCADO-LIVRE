...
router.post("/listarUsuarioBlackListPerguntas/post", bloqueioService.listarUsuarioBlackListPerguntas)
...
router.post("/listarUsuarioBlackListCompras/post", bloqueioService.listarUsuarioBlackListCompras)
